...
const PERMISSIONS = [
  ...
  { action: 'api::payment.payment.update', role: 'authenticated' },
  ...
  { action: 'api::feedback.feedback.create', role: 'authenticated' },
  { action: 'api::feedback.feedback.formatFeedback', role: 'authenticated' },
