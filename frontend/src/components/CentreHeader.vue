...
<template>
  <header class="flex justify-between items-start mb-6">
    <div v-if="isKioskApp" class="flex-1">
      <div
        class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-secondary-200 text-sm md:text-lg font-medium text-secondary-700 rounded-xl shadow-xs"
      >
